        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div  v-if="selectedUserId"
                    class="card-body chat-msg" v-chat-scroll>
                    <ul class="chat"  v-for="(message,index) in messages" :key="index"> 
                        ...
                        <li class="sender clearfix" v-if="!message.selfOwned" >
                           ...
                           <span class="chat-img right clearfix  mx-2" v-if="message.user.avatar">
                            ...
                            <span class="chat-img right clearfix  mx-2" v-else>
                               <img src="https://statics.olx.com.pk/external/base/img/avatar_4.png" width="50">
                            </span>
                        ...
                        <li class="buyer clearfix" v-else>
                            ...
                            <div class="chat-body clearfix">
                                ...
                                <p class="text-center" v-if="message.ads">
                                    <a :href="'/newprojects/classified/public/ad/'+message.ads.slug" target="_blank">
                                        {{message.ads.name}}
                                    </a>
...
export default {
    ...
    mounted(){
        ...
        axios.get('/newprojects/classified/public/admin/users').then((response)=>{
    ...
    methods:{
        sendMessage(){
            ...
            axios.post('/newprojects/classified/public/admin/start-chat',{
                body:this.body,
        ...
        showMessage(userId){
            axios.get('/newprojects/classified/public/admin/chat/user/'+userId).then((response)=>{
