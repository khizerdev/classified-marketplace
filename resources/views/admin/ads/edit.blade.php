...
<section class="adpost-part">
   <div class="container">
      <div class="row">
        ...
        @endif
            <form class="adpost-form" action="{{route('admin.ad.update' , $ad->id)}}" enctype="multipart/form-data" method="post">
                @method('PUT')
               @csrf
                  ...
                  <div class="row" id="app">
                     <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{$ad->name}}" placeholder="Type your product title here" name="name">
                            @error('name')
                     ...
                     <div class="col-md-4 col-lg-4">
                        <div class="form-group">
                           <ul class="form-check-list">
                            ...
                            <li>
                                <input name="condition" value="new" type="radio" class="form-check" id="new-check" @if($ad->condition === 'new') checked @endif>
                                <label for="new-check" class="form-check-text">
                                    new
                                    </label>
                                </li>
                              <li>
                                  <input name="condition" value="used" type="radio" class="form-check" id="use-check" @if($ad->condition === 'used') checked @endif>
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control  @error('price') is-invalid @enderror" value="{{$ad->price}}" placeholder="Enter your pricing amount">
                            @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                     ...
                     <div class="col-lg-12">
                        <div class="form-group">
                           ...
                           <input type="text" value="{{$ad->location}}" name="location" class="form-control @error('location') is-invalid @enderror">
                           @error('location')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" value="{{$ad->phone}}" class="form-control" placeholder="Your Phone no"></div>
                     </div>
                  </div>
               </div>
