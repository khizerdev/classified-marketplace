          ...
          <div class="col-lg-12">
             <div class="single-content">
                ...
                <ol class="breadcrumb">
                   ...
                   <li class="breadcrumb-item active" aria-current="page">{{$categorySlug}}</li>
                </ol>
             </div>
          </div>
       </div>
                       ...
                       <div class="product-sidebar-content">
                          <ul class="product-sidebar-list">
                             @foreach ($filteredByChildCategory as $category)    
                                <li>
                                    <a href="{{url()->current()}}/{{($category->childcategories->slug)??''}}">
                        ...
                        <form action="{{url()->current()}}" method="get">
                            <div class="product-sidebar-content mt-2">
                               <div class="price-range">
                                  ...
                                  <input type="number" name="minPrice" class="form-control bg-white">
                               </div>
                               <div class="price-range">
